          ...
          <View style={styles.modalBox}>
            <ScrollView>
              ...
              <Text style={styles.instruction}>
                1. <Text style={styles.bold}>Clean, Clear & Steady:</Text> No makeup, fresh skin.
              </Text>
              <Text style={styles.instruction}>
                2. <Text style={styles.bold}>Good Lighting:</Text> Use natural or well-lit space.
              </Text>
              <Text style={styles.instruction}>
                3. <Text style={styles.bold}>Focus:</Text> Keep your face in frame.
              </Text>
              <Text style={styles.instruction}>
                4. <Text style={styles.bold}>Close-up:</Text> Ensure skin details are visible.
              </Text>
              <Text style={styles.instruction}>
                5. <Text style={styles.bold}>Stay Still:</Text> Hold steady for clarity.
              </Text>
...
const styles = StyleSheet.create({
  ...
  video: { width: "100%", height: "100%", objectFit: "cover", backgroundColor: "#000" },
  capturedImage: { flex: 1, width: "100%", resizeMode: "contain", backgroundColor: "#000" },
  ...
  modalTitle: { fontSize: 22, fontWeight: "bold", marginBottom: 10, color: "white" },
